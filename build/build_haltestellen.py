...
def deduplicate_stops(raw_stops: list[dict]) -> list[dict]:
    ...
    gleicher Name + unter 8 m Abstand => zusammenfassen.
    8 m reicht aus um echte OSM-Duplikate (stop_position + platform am gleichen Mast)
    zu vereinen, fasst aber keine Gegenrichtungs-Steige zusammen (die typischerweise
    mindestens 15-30 m auseinanderliegen).
    """
    grouped: list[dict] = []
